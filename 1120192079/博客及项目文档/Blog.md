...
具体的语法请参阅：[asciimoo/exrex: Irregular methods on regular expressions (github.com)](https://github.com/asciimoo/exrex)下所给出的示例，注意网址中的 【.】 需要使用转义符 【\】 修饰，否则在正则表达式中是通配符
...
3. 简单测试了正则表达式的使用，以及gui界面的功能，把目前出现的小bug修复了
