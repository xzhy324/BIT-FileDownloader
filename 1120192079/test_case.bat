...
@echo test_case 2
python dev.py -u https://cdn.kernel.org/pub/linux/kernel/v5.x/linux-5.16.tar.xz

@echo test_case 3
python dev.py -u https://opus.nlpl.eu/download.php?f=ada83/v1/tmx/en-ru.tmx.gz
